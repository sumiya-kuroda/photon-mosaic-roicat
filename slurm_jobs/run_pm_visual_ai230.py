...
def run_pm():
    ...
    job_pm = executor_pm.submit(CommandFunction(["photon-mosaic", "--config", "/ceph/mrsic_flogel/public/projects/SuKu_20250111_FeedbackRF/configPhotonMosaicVisualInference_ai230.yaml", "--jobs", "30", "--latency-wait", "30", "--rerun-incomplete"])) # no space!
